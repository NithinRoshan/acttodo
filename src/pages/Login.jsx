...
function Login(props)
{
    ...
    return(
        ...
        <div className="bg-[#EFEFEF] p-10 border rounded-md flex flex-col items-center ">
...
<input 
                ...
                <p className="text-red-600">Don't have an account? <Link to={"/signup"} className="text-black underline">Sign Up</Link>  </p>
            </div>
        </div>
    </div>
    )
